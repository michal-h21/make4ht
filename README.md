...
Idea is to make system controlled by a build file. Because LUA interpreter 
is included in modern TeX distributions and LUA is ideal language for such task,
it was chosen as language in which build script are written.
